#!/bin/bash --login
#SBATCH --job-name=stats_diff_dose
#SBATCH -p serial
...
python analysis/statistical_tests.py \
    ...
    reports/resnet18_diffusion_curated_100pc_t070_predictions.csv \
    reports/resnet18_diffusion_curated_200pc_t070_predictions.csv \
    --out reports/resnet18_diffusion_strong_dose_t070_stats.csv \
    --bootstrap 2000
