#!/bin/bash --login
#SBATCH --job-name=train_r18_diff025
#SBATCH -p gpuL
#SBATCH -G 1
...
python analysis/train_resnet18_baseline.py \
    ...
    --synthetic-manifest reports/diffusion_7class_polished_t070_curated_minority_ratio025_manifest.csv \
    --out-dir models/resnet18_diffusion_curated_ratio025_t070 \
    --epochs 50 \
    --patience 10 \
    --batch-size 128 \
    --num-workers 1
