...
export OPENAI_LOGDIR="./classifier_sample_greedy/"
...
python scripts/classifier_sample.py \
    --model_path guided_logs_intensive/ema_0.9999_140000.pt \
    --classifier_path classifier_logs_greedy/model015000.pt \
    $G_MODEL_FLAGS $C_CLASSIFIER_FLAGS $SAMPLE_FLAGS
