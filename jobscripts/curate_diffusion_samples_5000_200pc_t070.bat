#!/bin/bash --login
#SBATCH --job-name=curate_diff200
#SBATCH -p serial
...
python analysis/curate_synthetic_samples.py \
    ...
    --out-dir data/synthetic/diffusion_7class_polished_t070_curated_200pc \
    --manifest reports/diffusion_7class_polished_t070_curated_200pc_manifest.csv \
    --scores-out reports/diffusion_7class_polished_t070_curated_200pc_scores.csv \
...
python utils/make_image_dir_contact_sheet.py \
    data/synthetic/diffusion_7class_polished_t070_curated_200pc \
    --out data/synthetic/diffusion_7class_polished_t070_curated_200pc/contact_sheet.png \
    --limit 120
