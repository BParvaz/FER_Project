#!/bin/bash --login
#SBATCH --job-name=train_r18_wgan_cur
#SBATCH -p gpuL
#SBATCH -G 1
...
python analysis/train_resnet18_baseline.py \
    ...
    --synthetic-manifest reports/wgan_version013_t070_curated_minority_manifest.csv \
    --out-dir models/resnet18_wgan_curated_minority_t070 \
    --epochs 50 \
    --patience 10 \
    --batch-size 128 \
    --num-workers 1
