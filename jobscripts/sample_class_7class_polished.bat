#!/bin/bash --login
#SBATCH --job-name=sample_class_7class_polished
#SBATCH -p gpuL
#SBATCH -G 1
...
export OPENAI_LOGDIR="./classifier_sample_7class_v1_polished_ddim250"
...
SAMPLE_FLAGS="--batch_size 10 --num_samples 70 --timestep_respacing ddim250 --use_ddim True --num_classes 7"
