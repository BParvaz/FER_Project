#!/bin/bash --login
#SBATCH --job-name=filter_wgan_t070
#SBATCH -p gpuL
#SBATCH -G 1
...
python analysis/filter_synthetic_samples.py \
    --npz WGAN/generated_samples/version_013_minority_2100/samples_2100x48x48x3.npz \
    --checkpoint models/resnet18_baseline_retrain/best.pth \
    --out-dir WGAN/generated_samples/version_013_minority_2100/resnet18_filtered_t070 \
