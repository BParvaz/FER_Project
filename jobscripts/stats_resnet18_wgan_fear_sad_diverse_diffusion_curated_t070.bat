#!/bin/bash --login
#SBATCH --job-name=stats_r18_fsd_diff
#SBATCH -p serial
...
python analysis/statistical_tests.py \
    ...
    reports/resnet18_wgan_curated_fear_sad_diverse_t070_predictions.csv \
    reports/resnet18_diffusion_curated_minority_t070_predictions.csv \
    --out reports/resnet18_baseline_vs_wgan_fear_sad_diverse_vs_diffusion_curated_t070_stats.csv \
    --bootstrap 2000
