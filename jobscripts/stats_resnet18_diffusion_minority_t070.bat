#!/bin/bash --login
#SBATCH --job-name=stats_r18_diff_t070
#SBATCH -p serial
...
python analysis/statistical_tests.py \
    ...
    reports/resnet18_diffusion_minority_t070_predictions.csv \
    --out reports/resnet18_baseline_vs_diffusion_minority_t070_stats.csv \
    --bootstrap 2000
