#!/bin/bash --login
#SBATCH --job-name=eval_r18_diff050
#SBATCH -p gpuL
#SBATCH -G 1
...
python analysis/evaluate_resnet18_baseline.py \
    ...
    --checkpoints models/resnet18_diffusion_curated_ratio050_t070/best.pth \
    --out reports/resnet18_diffusion_curated_ratio050_t070_eval.csv \
    --predictions-out reports/resnet18_diffusion_curated_ratio050_t070_predictions.csv \
    --batch-size 128 \
    --num-workers 1
