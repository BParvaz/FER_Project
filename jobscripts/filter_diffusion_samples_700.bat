#!/bin/bash --login
#SBATCH --job-name=filter_diff_700
#SBATCH -p gpuL
#SBATCH -G 1
...
python analysis/filter_synthetic_samples.py \
    --npz Diffusion/classifier_sample_7class_v1_polished_ddim250_700/samples_700x64x64x3.npz \
    --checkpoint models/resnet18_baseline_retrain/best.pth \
    --out-dir Diffusion/classifier_sample_7class_v1_polished_ddim250_700/resnet18_filtered_t070 \
