...
export OPENAI_LOGDIR="./guided_logs_intensive/"
...
C_TRAIN_FLAGS="--iterations 150000 --anneal_lr True --batch_size 128 --microbatch 8 --lr 3e-4 --save_interval 10000 --weight_decay 0.05"
...
python guided-diffusion/scripts/classifier_train.py --data_dir ./logs/$LATEST_MODEL $C_TRAIN_FLAGS $C_CLASSIFIER_FLAGS 
